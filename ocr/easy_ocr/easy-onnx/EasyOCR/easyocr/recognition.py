...
def recognizer_predict(model, converter, test_loader, batch_max_length,\
    ...
    with torch.no_grad():
        for image_tensors in test_loader:
            ...
            # preds = model(image, text_for_pred) #Comment for Onnx
            ...
            # model_save_path = "./onnx_models/recognizer.onnx"
            ...
            ######################### ONNX CHANGES ##########################
            # onnx_model_path = "C://Users//mikuv//Desktop//ryzen-ai-sw-1.1//RyzenAI-SW//easy-onnx//models//recognizer.onnx"
            onnx_model_path = "C://Users//mikuv//Desktop//ryzen-ai-sw-1.1//RyzenAI-SW//easy-onnx//models//recognizer_quantized.onnx"
